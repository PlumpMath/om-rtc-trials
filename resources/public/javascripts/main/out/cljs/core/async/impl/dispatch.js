...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_18968 = 0;while(true){
var m_18969 = cljs.core.async.impl.dispatch.tasks.pop();if((m_18969 == null))
{} else
{m_18969.call(null);
if((count_18968 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__18970 = (count_18968 + 1);
count_18968 = G__18970;
continue;
}
} else
{}
