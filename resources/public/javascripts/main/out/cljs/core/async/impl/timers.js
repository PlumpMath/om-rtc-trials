...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_18933 = 0;while(true){
if((i_18933 < arr.length))
{(arr[i_18933] = null);
{
...
{var i_18940 = (self__.level + 1);while(true){
if((i_18940 <= (new_level + 1)))
{(update[i_18940] = self__.header);
{
var G__18941 = (i_18940 + 1);
i_18940 = G__18941;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_18942 = 0;while(true){
if((i_18942 <= self__.level))
{var links_18943 = (update[i_18942]).forward;if(((links_18943[i_18942]) === x__$1))
{(links_18943[i_18942] = (x__$1.forward[i_18942]));
{
var G__18944 = (i_18942 + 1);
i_18942 = G__18944;
continue;
}
} else
{{
var G__18945 = (i_18942 + 1);
i_18942 = G__18945;
continue;
}
}
