...
{{
var G__16034 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16034;
continue;
}
} else
...
{var pred__16038 = cljs.core._EQ_;var expr__16039 = limit;if(cljs.core.truth_(pred__16038.call(null,1,expr__16039)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16038.call(null,2,expr__16039)))
...
var G__16041 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16042 = (limit__$1 - 1);
var G__16043 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16041;
limit__$1 = G__16042;
parts = G__16043;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___16045 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___16045))
{var replacement_16046 = temp__4090__auto___16045;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_16046)));
} else
{buffer.append(ch);
}
{
var G__16047 = (index + 1);
index = G__16047;
continue;
}
}
