...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj16448 = {};return obj16448;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__14883__auto__ = this$;if(and__14883__auto__)
...
{var x__15522__auto__ = (((this$ == null))?null:this$);return (function (){var or__14895__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__15522__auto__)]);if(or__14895__auto__)
{return or__14895__auto__;
} else
{var or__14895__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__14895__auto____$1)
...
return (function (p__16449){var vec__16450 = p__16449;var k = cljs.core.nth.call(null,vec__16450,0,null);var v = cljs.core.nth.call(null,vec__16450,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
