...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj17525 = {};return obj17525;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__14883__auto__ = this$;if(and__14883__auto__)
...
{var x__15522__auto__ = (((this$ == null))?null:this$);return (function (){var or__14895__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__15522__auto__)]);if(or__14895__auto__)
{return or__14895__auto__;
} else
{var or__14895__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__14895__auto____$1)
...
return (function (p__17526){var vec__17527 = p__17526;var k = cljs.core.nth.call(null,vec__17527,0,null);var v = cljs.core.nth.call(null,vec__17527,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__17528){var vec__17529 = p__17528;var k = cljs.core.nth.call(null,vec__17529,0,null);var v = cljs.core.nth.call(null,vec__17529,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
